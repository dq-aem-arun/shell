...
import com.shell.core.models.ShellTitle;
...
@Model(adaptables = { SlingHttpServletRequest.class }, adapters = { ShellTitle.class }, resourceType = {
        ShellTitleImpl.RESOURCE_TYPE }, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
public class ShellTitleImpl implements ShellTitle {

    protected static final String RESOURCE_TYPE = "shell/components/content/shell-title";
